...
product.productById = (req, res, next, id) => {
    Product.findById(id)
        .populate('category')
        .exec((err, product) => {
            if (err || !product) {
...
product.listCategories = (req, res) => {
...
// 				result:"failed",
// 				data:{},
// 				message:`could not upload images.Errors : ${err}`
// 			})
// 		}
